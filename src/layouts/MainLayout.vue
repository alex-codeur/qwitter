<template>
  <q-layout view="lHr lpR fFf">
    ...
    <q-drawer
      ...
      bordered
    >
      <q-icon class="q-pa-md" name="fas fa-dove" size="lg" color="info" />
      <q-list>
        <q-item to="/" clickable v-ripple exact>
          ...
          <q-item-section class="text-weight-bold text-h6">Home</q-item-section>
        </q-item>
    ...
    <q-drawer show-if-above v-model="rightDrawerOpen" side="right" bordered>
      ...
      <q-list separator padding>
        <q-item class="q-pa-md">
          <q-item-section>
            <q-item-label overline>Education</q-item-label>
            <q-item-label>Something Amazing happend!</q-item-label>
